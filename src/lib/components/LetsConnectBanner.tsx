...
export default function LetsConnectBanner() {
  return (
    <div className="flex aspect-[12/6] flex-col items-center justify-center rounded-2xl bg-design-background-secondary">
      ...
      <h2 className="mb-7 font-display text-8xl uppercase">
        Let&apos;s connect
      </h2>
      <Link
        className="uppercase flex items-center gap-2 rounded-full bg-design-accent px-8 py-2 font-medium text-design-background-primary"
        href={"/lets-talk"}
      >
